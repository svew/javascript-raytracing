...
function getWorld() {
	...
	// Push lights
	let lights = []
	lights.push(new PointLight(new Vector(0, 7, 2), COLORS.GREEN, 50)) //Green
	lights.push(new PointLight(new Vector(-2, 0.9, 1), COLORS.RED, 10)) //Red
	lights.push(new PointLight(new Vector(2, -5, -1), COLORS.BLUE, 20)) //Blue
